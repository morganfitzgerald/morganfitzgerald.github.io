...
- Physiological correlates of attention, memory, and cognitive state
- Disentangling cardiac influence from neural contamination in brain recordings
- Heart-brain coupling and cardiac-evoked cortical responses (TRF-HEP)
- Aperiodic (1/f) and oscillatory neural dynamics
- Bayesian hierarchical modeling and machine learning for large-scale datasets
- Open-source software for cardiac and neural signal analysis

---

## Technical Skills

- Python for signal processing, Bayesian modeling, machine learning, and visualization
- Open-source software development (*PyHEARTS* ECG analysis toolbox)
- MEG preprocessing, source reconstruction, and spectral parameterization (SpecParam, IRASA)
- Bayesian hierarchical models (PyMC, ArviZ)
- Documented, reproducible pipelines for large physiological datasets
- Git/GitHub for version control and collaborative development
- Scientific writing, documentation, and science communication
