...
redirect_from: "/more-evidence-1f-lffp-noise-indexes-excitationinhibition-balance/"
classes: wide
categories:
  - EIbalance
  - oscillations
...
<a href="{{'/assets/pdfs/posts/Gao-NeuroImage2017.pdf' | relative_url }}">(PDF)</a>, especially because the
...
Electrophysiological Noise” <a href="{{'/assets/pdfs/posts/Voytek-JNeurosci2015.pdf' | relative_url }}">(PDF)</a>,
...
<a href="{{'/assets/pdfs/posts/Voytek-BiolPsychiatry2015.pdf' | relative_url }}">(PDF)</a>. My lab
...
<br>
<img src="{{'/assets/images/posts/Voytek-LebloisJournalClub-Fig1-1024x550.jpg' | relative_url }}">
<br>
